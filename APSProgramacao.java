...
public class APSProgramacao {

    //   BONECOS
    static void boneco(String tipo) {
        String verde    = "\u001B[32m";
        String vermelho = "\u001B[31m";
        String amarelo  = "\u001B[33m";
        String azul     = "\u001B[36m";
        ...
        switch (tipo) {
            case "feliz" -> System.out.println(
                verde + "(^o^)" + reset
            );
            case "triste" -> System.out.println(
                vermelho + "(T_T)" + reset
            );
            case "surpreso" -> System.out.println(
                amarelo + "(0_0)" + reset
            );
            case "bemvindo" -> System.out.println(
                azul + "(^_^)/" + reset
            );
        }
    }
    ...
    public static void main(String[] args) {
        ...
        boneco("bemvindo");
        System.out.print("Seja bem vindo(a)! Qual o seu nome?\n-> ");
        nome = in.nextLine();
        System.out.println("=====================================================");
        System.out.println("Olá, " + nome + "! Pronto(a) para testar seus conhecimentos?");
        System.out.println("=====================================================");

        while (opcao != 4) {
            System.out.println("\nMENU PRINCIPAL - O que você quer simular, " + nome + "?");
            ...
            switch (opcao) {
                ...
                case 1 -> {
                    ...
                    System.out.println("O que você faz, " + nome + "?");
                    ...
                    if (escolha == 1) {
                        ...
                        linha();
                        System.out.println(nome + ", você caiu no golpe! Links encurtados como bit.ly escondem");
                        ...
                        linha();
                        System.out.println("Ótima decisão, " + nome + "! Antes de qualquer ação, sempre verifique");
                        ...
                        System.out.print(vermelho + "  ATENÇÃO - RESPOSTA ERRADA!  " + reset);
                        linha();
                        System.out.println(nome + ", encaminhar é ainda pior! Você estaria espalhando");
                ...
                case 2 -> {
                    ...
                    if (escolha == 1) {
                        ...
                        System.out.print(vermelho + "  ATENÇÃO - RESPOSTA ERRADA!  " + reset);
                        linha();
                        System.out.println(nome + ", você foi vítima de phishing! Nenhum banco jamais");
                        ...
                        System.out.print(verde + "  PARABÉNS - RESPOSTA CERTA!  " + reset);
                        linha();
                        System.out.println("Excelente, " + nome + "! Acessar o site oficial digitando o endereço");
                        ...
                        System.out.print(vermelho + "  ATENÇÃO - RESPOSTA ERRADA!  " + reset);
                        linha();
                        System.out.println(nome + ", responder confirma que seu e-mail existe e está ativo.");
                ...
                case 3 -> {
                    ...
                    if (escolha == 1) {
                        ...
                        System.out.print(vermelho + "  ATENÇÃO - RESPOSTA ERRADA!  " + reset);
                        linha();
                        System.out.println(nome + ", esperar é um erro grave! A cada minuto, seus seguidores");
                        ...
                        System.out.print(verde + "  PARABÉNS - RESPOSTA CERTA!  " + reset);
                        linha();
                        System.out.println("Perfeito, " + nome + "! Avisar seus contatos evita que caiam no golpe.");
                        ...
                        System.out.print(vermelho + "  ATENÇÃO - RESPOSTA ERRADA!  " + reset);
                        linha();
                        System.out.println(nome + ", abandonar não resolve! Sua conta antiga continua ativa");
                ...
                case 4 -> {
                    boneco("feliz");
                    System.out.println("\n============================================================");
                    System.out.println(nome + ", você acertou " + verde + contadorCerto + reset + " e errou " + vermelho + contadorErro + reset + " questões!");
                    if (contadorCerto == 3 || contadorErro == 0) {
                        System.out.println(verde + "Incrível, " + nome + "! Você gabaritou! Está protegido(a) contra golpes!" + reset);
                    } else if (contadorCerto == 2) {
                        System.out.println(amarelo + "Bom trabalho, " + nome + "! Mas ainda tem espaço pra melhorar!" + reset);
                    } else {
                        System.out.println(vermelho + nome + ", vale revisar as dicas! A segurança digital é importante!" + reset);
                    }
                    System.out.println(azul + "Obrigado por usar o Guia de Segurança Digital, " + nome + "! Até mais!" + reset);
                    System.out.println("============================================================\n");
                }
